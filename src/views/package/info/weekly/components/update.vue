...
const props = defineProps({
  ...
  model: {
    request: true,
    type: Object as PropType<Package.ReqWeeklyUpdateParams>,
  },
})
...
const FormData = reactive({
  model: lodash.cloneDeep(props.model) as Package.ReqWeeklyUpdateParams,
  handleSubmit: () => {
    formRef.value.validate(async (errors: any) => {
      try {
        if (!errors) {
          await packageStore.apiPackageWeeklyUpdate(FormData.model)
